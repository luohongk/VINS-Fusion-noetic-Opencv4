...
```
    ...
    rosrun vins vins_node ~/catkin_ws/src/VINS-Fusion-noetic-Opencv4/config/euroc/euroc_mono_imu_config.yaml 
    (optional) rosrun loop_fusion loop_fusion_node ~/catkin_ws/src/VINS-Fusion-noetic-Opencv4/config/euroc/euroc_mono_imu_config.yaml 
